...
### How Our Goals Changed
  ...
  <p>Within the src file, you will find our Hand Detection and LiDAR Collision Avoidance ROS2 packages in addition to a test directory with a test file we used to test out the AI model on ur Jetson Nano.<p>
